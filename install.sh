...
read -p "Enter domain or IP for Panel: " DOMAIN
...
echo "Running Pelican environment setup..."
...
echo "Open: http://${DOMAIN}/installer"
echo "DB: pelican"
echo "User: pelican"
echo "Pass: ${DBPASS}"
echo "--------------------------------------"
...
echo "Create node in Panel"
echo "Paste config to /etc/pelican/config.yml"
echo "Then run: systemctl enable --now wings"
echo "--------------------------------------"
}
